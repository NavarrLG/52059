...
// Agrega aquí los imports necesarios para fs, CharStreams, ECMASGLexer, ECMASGParser, CommonTokenStream
...
export default class CustomECMASGVisitor extends ECMASGVisitor {
    ...
    // Traducción a JS (no evalúa, solo traduce)
    ...
    // Traducción de expresiones a JS
    visitExpr(ctx) {
        if (ctx.term().length === 1) {
